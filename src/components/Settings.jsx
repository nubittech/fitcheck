...
const Settings = ({ onClose, onLogout }) => {
  ...
  if (currentView === 'terms') {
    return <LegalPage title="Terms of Service" content={TERMS_OF_SERVICE} onBack={() => setCurrentView('main')} />
  }
  if (currentView === 'guidelines') {
    return <LegalPage title="Community Guidelines" content={COMMUNITY_GUIDELINES} onBack={() => setCurrentView('main')} />
  }
